    ...
    <header>
      <nav>
          ...
          <ul className="navs">
            {links.map((link) => (
              <li
                ...
                className={
                  "nav-link uppercase body-font " + checkActiveLink(link)
                }
              >
        ...
        <ul className="navs-info">
          <li
            className={
              "nav-link uppercase body-font text-dark-gray " +
              activeBtnClass("overview", selectedInfo)
            }
          ...
          <li
            className={
              "nav-link uppercase body-font text-dark-gray " +
              activeBtnClass("internal structure", selectedInfo)
            }
          ...
          <li
            className={
              "nav-link uppercase body-font text-dark-gray " +
              activeBtnClass("surface geology", selectedInfo)
            }
