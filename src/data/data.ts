import { EarthGeology, EarthInternal, EarthPlanet, JupiterGeology, JupiterInternal, JupiterPlanet, MarsGeology, MarsInternal, MarsPlanet, MecuryGeology, MecuryInternal, MecuryPlanet, NeptuneGeology, NeptuneInternal, NeptunePlanet, SaturnGeology, SaturnInternal, SaturnPlanet, UranusGeology, UranusInternal, UranusPlanet, VenusGeology, VenusInternal, VenusPlanet } from "./imageData";
...
const planetsData = [
  {
    ...
    "images": {
      "planet": MecuryPlanet,
      "internal": MecuryInternal,
      "geology": MecuryGeology
    }
  },
  {
    "name": "Venus",
